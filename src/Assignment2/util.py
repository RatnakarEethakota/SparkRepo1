...
def creating_rdd(spark,filepath):
    rdd = spark.sparkContext.textFile("C:/Users/ASUS/PycharmProjects/pythonProject6/SparkRepo1/resource/ghtorrent-logs.txt")
    return rdd
...
def reading_file(spark,filepath):
    df = spark.read.text("C:/Users/ASUS/PycharmProjects/pythonProject6/SparkRepo1/resource/ghtorrent-logs.txt")
    return df
